...
const (
	Ping_Ping_FullMethodName = "/logStore.Ping/Ping"
)
...
func (c *pingClient) Ping(ctx context.Context, in *PingReq, opts ...grpc.CallOption) (*PongRes, error) {
...
func (UnimplementedPingServer) Ping(context.Context, *PingReq) (*PongRes, error) {
