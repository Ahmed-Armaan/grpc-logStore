...
const file_healthcheck_proto_rawDesc = "" +
	"\n" +
	"\x11healthcheck.proto\x12\blogStore\"\x1d\n" +
	"\aPingReq\x12\x12\n" +
	"\x04ping\x18\x01 \x01(\tR\x04ping\"\x1d\n" +
	"\aPongRes\x12\x12\n" +
	"\x04pong\x18\x01 \x01(\tR\x04pong26\n" +
	"\x04Ping\x12.\n" +
	"\x04Ping\x12\x11.logStore.PingReq\x1a\x11.logStore.PongRes\"\x00B\fZ\n" +
	"./logStoreb\x06proto3"
...
var file_healthcheck_proto_goTypes = []any{
	(*PingReq)(nil), // 0: logStore.PingReq
	(*PongRes)(nil), // 1: logStore.PongRes
}
var file_healthcheck_proto_depIdxs = []int32{
	0, // 0: logStore.Ping.Ping:input_type -> logStore.PingReq
	1, // 1: logStore.Ping.Ping:output_type -> logStore.PongRes
